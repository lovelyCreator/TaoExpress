...
import { customerOrdersApi } from '../../services/customerOrdersApi';
import { usePostProductReviewsMutation } from '../../hooks/useReviewsMutations';
...
const LeaveFeedbackScreen: React.FC = () => {
  ...
  console.log("Variations", product);
    ...
    const { 
      postProductReviews, data, error, isLoading, isSuccess, isError
    } = usePostProductReviewsMutation({
      onSuccess: (data) => {
        Alert.alert(
          'Success',
  ...
  const handleSubmitFeedback = async () => {
    ...
    try {
      ...
      postProductReviews({ productId: product?.item_id, orderId, rating, comment })
      // Alert.alert(
      //   'Feedback Submitted',
